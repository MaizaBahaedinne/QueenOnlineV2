...
@section('content')
    @php
        $fullName = $staff->full_name !== '' ? $staff->full_name : ('Ressource Humaine #' . $staff->id);
    ...
    <section class="staff-profile">
        <article class="staff-hero">
            ...
            <div class="action-row"><a href="{{ route('staff.index') }}" class="btn">Retour Ressource Humaine</a></div>
        </article>
